  ...
  return (
    <div className="max-w-[1400px] mx-auto px-6 md:px-12">
      ...
      <section className="pt-12 pb-8 md:pt-16 md:pb-12">
        ...
        <p className="mt-4 text-neutral-500 text-base md:text-lg max-w-3xl leading-relaxed">
          {project.subtitle}
        </p>
      </section>
      ...
      <section className="border-t border-b border-black/10 py-6 mb-12">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          ...
          <MetaItem label="Category" value={CATEGORY_LABELS[project.category as Category] || project.category} />
          ...
          {project.collaborators && (
            <MetaItem label="Collaborators" value={project.collaborators} />
          )}
        </div>
      </section>
